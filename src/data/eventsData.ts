...
const eventsData: Record<string, EventData> = {
  "annual-chemistry-conference-2025": {
    ...
    location: "Kwame Nkrumah University of Science & Technology, KNUST-Kumasi, Ghana",
    ...
    longDescription: "Join us for the premier chemistry event in Ghana, featuring keynote speeches, research presentations, and networking opportunities.\n\nThis year's theme focuses on \"Sustainable Chemistry for National Development\" with speakers from industry, academia, and government discussing the latest advancements and challenges in chemistry research and applications in Ghana and beyond.",
    attendees: 400,
    organizers: "Ghana Chemical Society - Conference Committee",
    schedule: [
      { day: "Day 1 - September 22", items: [
        { time: "08:00 AM", activity: "Registration" },
        { time: "09:00 AM", activity: "Opening Ceremony" },
        { time: "10:30 AM", activity: "Keynote Address: Sustainable Chemistry in Africa" },
        { time: "12:00 PM", activity: "Lunch Break" },
        { time: "01:30 PM", activity: "Panel Discussion: Chemistry Education in Ghana" },
    ...
    image: "https://images.unsplash.com/photo-1576086213369-97a306d36557?ixlib=rb-1.2.1&auto=format&fit=crop&w=1200&q=80",
    speakers: [
      { name: "Prof. Ama Boahen", title: "Lead Researcher", institution: "University of Ghana", topic: "Sustainable Chemistry in Africa" },
      { name: "Dr. Kwame Asante", title: "Director", institution: "Ghana Water Company Limited", topic: "Water Quality and Treatment" },
      { name: "Prof. Daniel Nti", title: "Dean", institution: "KNUST Faculty of Science", topic: "Chemistry Education in Ghana" },
      { name: "Dr. Abena Mensah", title: "Senior Scientist", institution: "Environmental Protection Agency", topic: "Green Chemistry Innovations" },
      { name: "Prof. John Owusu", title: "Department Chair", institution: "University of Cape Coast", topic: "Industrial Applications of Chemistry" }
    ],
    partners: [
      { name: "Ghana Water Company Limited, GWCL", logo: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80" },
      { name: "Kwame Nkrumah University of Science and Technology, KNUST", logo: "https://images.unsplash.com/photo-1488590528505-98d2b5aba04b?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80" },
      { name: "University of Cape Coast, UCC", logo: "https://images.unsplash.com/photo-1461749280684-dccba630e2f6?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80" },
      { name: "University of Education Winneba, UEW", logo: "https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80" },
      { name: "University of Ghana, Legon", logo: "https://images.unsplash.com/photo-1576086213369-97a306d36557?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80" },
      { name: "University of Energy and Natural Resources, UENR", logo: "https://images.unsplash.com/photo-1507413245164-6160d8298b31?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80" },
      { name: "University of Professional Studies, Accra, UPSA", logo: "https://images.unsplash.com/photo-1560179707-f14e90ef3603?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80" },
      { name: "Food and Drugs Board Authority, Ghana", logo: "https://images.unsplash.com/photo-1532187863486-abf9dbad1b69?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80" },
      { name: "Environmental Protection Agency", logo: "https://images.unsplash.com/photo-1496307653780-42ee777d4833?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80" },
      { name: "C.K. Tedam University of Technology and Applied Science, CKT-UTAS", logo: "https://images.unsplash.com/photo-1532094349884-543bc11b234d?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80" },
    ],
    type: "conference"
  },
